# My first game in Python (Brazilian version below)
...
***Indie developer: this project still in development. If you want to have the full experience, please wait!***  
***If someone wants to suggest idea to the game or report a bug, contact this handsome guy: eudeveloper143@gmail.com***  
***100% human-made. No AI was harmed in the process.***


**Trigger Warning:** (*If you want to avoid spoilers and are not sensitive to heavy themes, skip this section.*) 
<details>
  <summary><b>Click here to expand if you are sensitive to heavy themes</b></summary>  
...
***100% humano. Nenhuma IA foi prejudicada no progresso.***  
